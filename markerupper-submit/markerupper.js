(function () {
  ...
  function menuClicked (e) {
   ...
   // Toggle the menu button that was clicked
    ...
    // if (type === 'backColor'){
    //       document.execCommand(type, false, backgroundColor) // toggle the type of whatever is selected
    // }
    // else {
...
// import "https://fonts.googleapis.com/icon?family=Material+Icons";
  ...
  if (document.readyState === 'loading') {
    ...
    // document.addEventListener('DOMContentLoaded', openMenu.bind(null, 'INSTALL')) cloudflare tofo reenable
  } else {
    updateFormats()
    // openMenu('INSTALL') todo reendo for apps platform cloudflare
  }
